...
public class ComplexTest {
    ...
    @Test
    void testEquals() {
        assertEquals(false,onePlusI.equals(oneMinusI));
    ...
    void testMultiply(){
        ...
        assertEquals(new Complex(-2,2),onePlusI.multiply(twoI));
    ...
    void testModulus() {
        ...
        assertEquals(Math.sqrt(4), twoI.modulus());
    }

    @Test
    void testAdd(){
        assertEquals(onePlusI,onePlusI.add(new Complex(0,0)));
        assertEquals(new Complex(3,1),onePlusI.add(two));
        assertEquals(new Complex(1,3),onePlusI.add(twoI));
        assertEquals(new Complex(2,2),onePlusI.add(onePlusI));
    }
}